...
//@interface MIGNewsObject : NSObject
//@end

@interface MIGNewsObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[MIGNewsObject class]])
		{
			for (NSString *key in [[(MIGNewsObject*)o modules] allKeys])
			{
