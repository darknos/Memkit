...
// in simulator we redefine to format for MIGNews Developer console
...
{\
	NSString * exceptionName = [@"org.mignews." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.mignews";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIMIGNewsNativeItemNone = -1, 
	UIMIGNewsNativeItemSpinner = -2,
	UIMIGNewsNativeItemProgressBar = -3,
	
	UIMIGNewsNativeItemSlider = -4,
	UIMIGNewsNativeItemSwitch = -5,
	UIMIGNewsNativeItemMultiButton = -6,
	UIMIGNewsNativeItemSegmented = -7,
	
	UIMIGNewsNativeItemTextView = -8,
	UIMIGNewsNativeItemTextField = -9,
	UIMIGNewsNativeItemSearchBar = -10,
	
	UIMIGNewsNativeItemPicker = -11,
	UIMIGNewsNativeItemDatePicker = -12,
	
	UIMIGNewsNativeItemInfoLight = -13,
	UIMIGNewsNativeItemInfoDark = -14,
	
	UIMIGNewsNativeItemDisclosure = -15,
	
	UIMIGNewsNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all MIGNews instances of
