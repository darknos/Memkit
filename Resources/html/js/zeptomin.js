(function(a) {
    String.prototype.trim === a && (String.prototype.trim = function() {
        ...
        while (d > e) e in c && (f = b.call(a, f, c[e], e, c)), e++;
        return f;
    });
})();
...
var Zepto = function() {
    ...
    c.isEmptyObject = function(a) {
        ...
        var c, e, f, d = [];
        if (L(a)) for (e = 0; a.length > e; e++) c = b(a[e], e), null != c && d.push(c); else for (f in a) c = b(a[f], f), 
        null != c && d.push(c);
        return N(d);
    }, c.each = function(a, b) {
        var c, d;
        if (L(a)) {
            for (c = 0; a.length > c; c++) if (b.call(a[c], c, a[c]) === !1) return a;
        ...
        parents: function(a) {
            ...
            while (d.length > 0) d = c.map(d, function(a) {
                if ((a = a.parentNode) && !H(a) && 0 > b.indexOf(a)) return b.push(a), a;
            });
            return U(b, a);
        },
        parent: function(a) {
        ...
        css: function(a, c) {
            if (2 > arguments.length && "string" == typeof a) return this[0] && (this[0].style[B(a)] || k(this[0], "").getPropertyValue(a));
            var d = "";
        ...
        offsetParent: function() {
            return this.map(function() {
                ...
                while (a && !o.test(a.nodeName) && "static" == c(a).css("position")) a = a.offsetParent;
                return a;
            });
        }
        ...
        c.fn[a] = function() {
            ...
            return 1 > e.length ? this : this.each(function(a, h) {
...
window.Zepto = Zepto, "$" in window || (window.$ = Zepto), function(a) {
    ...
    a.fn.delegate = function(b, c, d) {
        ...
        ("string" == typeof b || a.isPlainObject(b)) && (b = a.Event(b));
    ...
    a.fx = {
        ...
        if ("string" == typeof c) h[o] = c, h[p] = d + "s", h[q] = e || "linear", w = a.fx.animationEnd; else {
            i = [];
